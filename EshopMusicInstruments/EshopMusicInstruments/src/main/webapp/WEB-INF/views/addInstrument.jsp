        ...
        <div class="uk-container uk-container-expand">
            ...
            <div class="uk-grid-match  uk-height-1-1" uk-grid>
                ...
                <div class="uk-height-1-1 uk-align-center   ">
                    ...
                    <div class="">
                        <form:form method="POST" action="save" modelAttribute="instrument"
                            class="uk-form-horizontal uk-margin-large">
                            <div class="uk-margin">


                                <form:input type="hidden" path="instrumentId" id="name" class="uk-input" />
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <form:input type="text" path="model" id="model" class="uk-input" required="required" />
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <form:input type="number" path="price" id="price" class="uk-input" required="required" />
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <form:input type="text" path="brand" id="brand" class="uk-input" required="required" />
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <form:input type="text" path="description" id="description" class="uk-input"
                                required="required" />
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <form:input type="text" path="type" id="type" class="uk-input" required="required" />
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <input class="uk-input uk-form-width-small uk-button uk-button-primary " value="new"
                                type="Submit" />
                        </div>
                    </div>
